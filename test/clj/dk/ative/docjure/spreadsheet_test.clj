...
(def config {:datatypes-file  "test/clj/dk/ative/docjure/testdata/datatypes.xlsx"
             :formulae-file   "test/clj/dk/ative/docjure/testdata/formulae.xlsx"
             :blanks-file "test/clj/dk/ative/docjure/testdata/blanks.xlsx"
             :1900-based-file "test/clj/dk/ative/docjure/testdata/1900-based-dates.xlsx"
             :1904-based-file "test/clj/dk/ative/docjure/testdata/1904-based-dates.xlsx"
             :simple "test/clj/dk/ative/docjure/testdata/simple.xlsx"
             :save-workbook-location "test/clj/dk/ative/docjure/testdata/saved.xlsx"})
